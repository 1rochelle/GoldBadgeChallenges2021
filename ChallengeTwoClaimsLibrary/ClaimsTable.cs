...
//{
//    //Read article and implemented code from https://genert.org/blog/csharp-programming/
//    //Mostly copied & pasted, but I changed the table name to make sense with my project.
//    //I believe I understand everything that's happening here.
//    public class ClaimsTable
//    {
//        private List<object> _columns { get; set; }
//        private List<object[]> _rows { get; set; }
//        public ClaimsTable (params string[] columns)
//        {
